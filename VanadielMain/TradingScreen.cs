    ...
    public partial class TradingScreen : Form
    {
        ...
        private void dgvMyItems_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if(e.ColumnIndex == 4)
            {
                ...
                Item itemBeingSold = _World.ItemByID(Convert.ToInt32(itemID));

                if (itemBeingSold.Price == _World.UNSELLABLE_ITEM)
                {
                ...
                else
                {
                    ...
                    _currentPlayer.Gold += itemBeingSold.Price / 2;
                }
            }
        }
        ...
        private void dgvVendorItems_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if(e.ColumnIndex == 3)
            {
                ...
                Item itemBeingBought = _World.ItemByID(Convert.ToInt32(itemID));
